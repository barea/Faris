...
class CheckinsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create checkin" do
    assert_difference('Checkin.count') do
      post checkins_url, params: { checkin: { costumer_id: @checkin.costumer_id, datetime: @checkin.datetime, store_id: @checkin.store_id, temp: @checkin.temp } }
    end
  ...
  test "should update checkin" do
    patch checkin_url(@checkin), params: { checkin: { costumer_id: @checkin.costumer_id, datetime: @checkin.datetime, store_id: @checkin.store_id, temp: @checkin.temp } }
